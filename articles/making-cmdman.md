...
![](/images/making-cmdman/tui-popup.webp)
...
- コマンドモニターとの通信は[gRPC]で行うことにしました。
  - schema中心かつcode generator前提なのでclient/server stubがschemaから生成可能。私の知る限り、現状一番簡単にbi-di RPCを記述する方法です。
...
![](/images/making-cmdman/mux-tmux-claude-3-col.webp)

_claude 3 col layout_

アプリはそのまま動いてて、レイアウトだけ変わってるのがわかると思います。
...
![](/images/making-cmdman/tui-popup-scrambled-tty-output.webp)
